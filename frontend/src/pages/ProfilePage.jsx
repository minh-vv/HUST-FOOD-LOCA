                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {favorites.restaurants.map((item) => (
                      <RestaurantCard
                        ...
                        onRemove={() =>
                          handleRemoveFavorite("restaurant", item.restaurant_id)
                        }
                      />
                    ))}
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {saved.restaurants.map((item) => (
                      <RestaurantCard
                        ...
                        onRemove={() =>
                          handleRemoveSaved("restaurant", item.restaurant_id)
                        }
                        isSaved
                      />
                    ))}
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl w-full max-w-lg max-h-[90vh] overflow-hidden shadow-2xl">
        ...
        <div className="flex gap-3 p-6 border-t bg-gray-50">
          ...
          <button
            onClick={
              activeTab === "basic" ? handleSaveBasicInfo : handleSavePassword
            }
